class libro ():
    ...
    def mismo_autor(self,lista,autor):
        resultado = []
        for libro in lista:
            if str(autor)==libro[1]:
...
print(libro2.largo())
print("")
print(libro1.mismo_autor([("Cuentos para niños","Gabriel Garcia Marquez",400,"ED.Amanecer","mkl675"),("Programacion 1","Juan Perez",800,"ED.Amanecer","mkl675"),("Analisis Matematico","Juan Perez",600,"ED.Amanecer","mkl675"),("Cuentos para niños","Maria Cardozo",600,"ED.Amanecer","mkl675"),("Cuentos para niños2","Gabriel Garcia Marquez",600,"ED.Amanecer","mkl675")],"Gabriel Garcia Marquez"))
