...
def devolver_datos():
    codigo_farmacia = mas_cercana_abierta_con_medicamento()
    archivo = open("C:\\Users\\usuario\\AppData\\Local\\Programs\\Python\\Python36-32\\cgi-bin\\farmacias.dat")
    for linea in archivo:
        datos = linea.strip().split(",")
        if datos [0] == codigo_farmacia:
            respuesta = "Nombre: "+datos[1]+"<br>Dirección: "+datos[2]+"<br>Teléfono: "+datos[3]+"<br>Horario: de "+datos[4]+" a "+datos[5]
    return respuesta
...
print ("")
h1="""<html>
	<head><title>Farmab&uacute;squeda</title>
	</head>
		<body bgcolor="6db7da"/>"""
h2="""<hr align=left>
    <h5 align=right><font size="2" align=left>Realizado por: <br> Micaela Olivera, Agustin Picos</font><br>
				
    <font size="3" align=left><i>Universidad Cat&oacute;lica del Uruguay</i></font></h5>
</form>
</body>
</html>"""
...
if "medicamento" not in params or "mi_ubicacion_actual" not in params:
    ...
    medicamento = params.getvalue("medicamento").lower()
    ubicacion1= params.getvalue("mi_ubicacion_actual").lower()
    try:
        print(h1,"Farmacia más cercana:<br>",devolver_datos(),h2)
    except IndexError:
        print("<h1>Error: verifique los datos de direccion y medicamento</h1>")
    except UnboundLocalError:
        print("<h1>No hay farmacias abiertas en este momento</h1>")
...
#print(devolver_datos())# esta es la unica salida
